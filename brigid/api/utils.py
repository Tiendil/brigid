...
def construct_index_title(language: str, title: str, page: int, tags_required: Iterable[str], tags_excluded: Iterable[str]) -> str:
...
def construct_index_description(language: str, subtitle: str, page: int, tags_required: Iterable[str], tags_excluded: Iterable[str]) -> str:
