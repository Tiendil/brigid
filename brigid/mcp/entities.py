...
class PageInfo(BaseEntity, DocMixin):
    ...
    tags: Annotated[set[str], Field(description="Set of tags associated with the blog post")]
    ...
    intro: Annotated[str, Field(description="Introductory content of the blog post")]
...
class FilteredPosts(BaseEntity, DocMixin):
    ...
    tags: Annotated[dict[str, int], Field(description="Tag counts of the filtered posts")]
