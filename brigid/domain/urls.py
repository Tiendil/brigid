...
class UrlsBase:
    ...
    def to_filter(self, page: int = 1, require: Iterable[str] = (), exclude: Iterable[str] = ()) -> "UrlsTags":
        return UrlsTags(language=self.language,
                        page=page,
...
class UrlsTags(UrlsBase):
    ...
    def __init__(self, page: int, required_tags: Iterable[str], excluded_tags: Iterable[str], **kwargs) -> None:
        super().__init__(**kwargs)
    ...
    def total_pages(self) -> int:
        ...
        all_pages = storage.last_pages(language=self.language,
